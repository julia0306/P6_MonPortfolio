...
// J'import les composants dont j'ai besoin 
import Collapsible from "../../Components/Collapsible/collapsible";
import ComicPanel from "../../Components/Comic-panels/comicPanels";
// J'importe les images nécessaires pour instaurer les images adaptatives
...
function Skills() {
    // Je redirige l'utilisateur vers le haut de la page lorsqu'il arrive dessus
                ...
                <div className="skills__technical">
                    ...
                    <div className="skills__map">
                        <div className="textZone">
                            <h3>
                                Liens vers les projets ayant validé les compétences
                            </h3>
                            ...
                            <img
                                ...
                                sizes="(max-width: 600px) 400px, (max-width: 780px) 600px, (max-width: 1200px) 1000px, (min-width: 1025px) 100vw"
                                max-width="1300px"
                                max-height="480px"
                            />
                                <div className="skills__buttons">
                                    <Link to="/project/1" title="Voir le projet Booki">
                                        <button className="skills__button skills__button__2" aria-label='voir le projet "Booki"'>
                                        </button>
                                    </Link>
                                    <Link to="/project/2" title="Voir le projet Sophie Bluel">
                                        <button className="skills__button skills__button__3" aria-label='voir le projet "Sophie Bluel"'>
                                        </button>
                                    </Link>
                                    <Link to="/project/3" title="Voir le projet Menu Maker">
                                        <button className="skills__button skills__button__4" aria-label='voir le projet "Menu Maker"'>
                                        </button>
                                    </Link>
                                    <Link to="/project/4" title="Voir le projet Nina Carducci">
                                        <button className="skills__button skills__button__5" aria-label='voir le projet "Nina Carducci"'>
                                        </button>
                                    </Link>
                                    <Link to="/project/5" title="Voir le projet Kasa">
                                        <button className="skills__button skills__button__6" aria-label='voir le projet "Kasa"'>
                                        </button>
                                    </Link>
                                    <Link to="/project/6" title="Voir le projet Mon vieux Grimoire">
                                        <button className="skills__button skills__button__7" aria-label='voir le projet "Mon Vieux Grimoire"'>
                                        </button>
                                    </Link>
                                </div>
                            </div>
