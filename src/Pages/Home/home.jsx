    ...
    return (
        <main>
            <div className="welcome__message">
                ...
                text= "Je suis Julia Taylor et je suis développeuse web front-end. De nationalité britannique, je suis expatriée en France depuis de longues années maintenant. J'y ai réalisé l'ensemble de mes études, en commençant par une licence en langues étrangères appliquées, en bifurquant par une année de médecine, en transitant par un master en enseignement et en aboutissant dans le domaine du développement web. Passionnée et curieuse, intéressée et ayant toujours envie d'apprendre, je vois dans ce secteur un terreau fertile pour continuer à me cultiver."
