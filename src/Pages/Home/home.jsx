      ...
      <main>
          <div className="welcome__message">
              <TextZone
                ...
                text="Je suis Julia Taylor et je suis développeuse web. Ce site portfolio vous présentera mon parcours de formation. Il se focalisera sur le parcours de 'développeur intégrateur web' que j'ai suivi chez OpenClassrooms pendant une durée de 6 mois. Il sera, par ailleurs, complété par mes projets personnels au fil du temps et de mes réalisations. Axée sur une pédagogie de projets, la formation OpenClassrooms m'a permis de consolider les connaissances que j'avais acquises préalablement en HTML et CSS. Par ailleurs, elle a été l'occasion pour moi de découvrir davantage en profondeur le Javascript et de m'initier également au développement back-end. Cette formation ayant confirmé l'orientation que je souhaite donner à ma carrière professionnelle, je suis actuellement à la recherche d'un poste en entreprise -ou au sein d'une association- qui me permettra d'approfondir mes compétences en développement, le tout en acquérant une première expérience professionnelle dans ce domaine."
